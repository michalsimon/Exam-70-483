namespace ConsumingData
{
    ...
    public class ADONETSamples
    {
        ...
        public static void CommandExecuteNonQueryText()
        {
            SqlConnection cn = new SqlConnection();

            // cn.ConnectionString = "Server=myServerAddress;Database=myDataBase;User Id=myUsername;Password=myPassword;";
            cn.ConnectionString = @"Server = (local)\SQL2014; Database = Reflection; Trusted_Connection = True;";
            cn.Open();
        ...
        public static void CommandExecuteNonQueryStoredProcedure()
        {
            SqlConnection cn = new SqlConnection();
        ...
        public static void CommandExecuteReader()
        {
            SqlConnection cn = new SqlConnection();
        ...
        public static void CommandExecuteScalar()
        {
            SqlConnection cn = new SqlConnection();
        ...
        public static void CommandExecuteXmlReader()
        {
            SqlConnection cn = new SqlConnection();
        ...
        public static void DataSetPopulate()
        {
            SqlConnection cn = new SqlConnection();
        ...
        public static void DataSetInsert()
        {
            SqlConnection cn = new SqlConnection();
        ...
        public static void DataSetUpdateDelete()
        {
            SqlConnection cn = new SqlConnection();
